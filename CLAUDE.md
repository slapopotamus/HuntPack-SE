...
2. **Use the local skill.** Hunt requests in this project go through
   `huntpack-agent-local` (`.claude/skills/huntpack-agent-local/`) — a self-contained
...
See `README.md` for usage and `.claude/skills/huntpack-agent-local/references/conventions.md`
